...
namespace RTEditor
{
    public class GameObjectSphereTree
    {
        ...
        public void MaskObjectCollection(IEnumerable<GameObject> gameObjects)
        {
            foreach (var gameObj in gameObjects) MaskObject(gameObj);
        }
        ...
        public void MaskObject(GameObject gameObj)
        {
            ...
            if (_gameObjectToTransformData.ContainsKey(gameObj)) _gameObjectToTransformData.Remove(gameObj);
        }

        public void UnmaskObjectCollection(IEnumerable<GameObject> gameObjects)
        {
            foreach (var gameObj in gameObjects) UnmaskObjct(gameObj);
        }

        public void UnmaskObjct(GameObject gameObj)
        {
            _maskedObjects.Remove(gameObj);       
        }

        public bool IsObjectMasked(GameObject gameObj)
        {
            return _maskedObjects.Contains(gameObj);
        }
        ...
        private bool RegisterGameObject(GameObject gameObject)
        {
            ...
            {
                EditorMeshDatabase.Instance.CreateEditorMesh(gameObject.GetMesh());
            }
        ...
        {
            if (IsObjectMasked(gameObject)) return false;
