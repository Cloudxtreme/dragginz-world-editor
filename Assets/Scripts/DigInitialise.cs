...
namespace DragginzWorldEditor
{
    ...
    /// ...
    /// </summary>
    public class DigInitialise : MonoSingleton<DigInitialise>
    {
        ...
        void Start() {
			...
			DigMainMenu.Instance.setShapeTypeButtons (_iCurShapeType);
			DigMainMenu.Instance.setShapeSizeButtons (_iCurShapeSizeIndex);
			DigMainMenu.Instance.setDigSizeButtons (_iCurDigSizeIndex);
